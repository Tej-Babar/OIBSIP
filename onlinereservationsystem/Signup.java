...
public class Signup {
    ...
    public Signup() {
        ...
        signupFrame = new JFrame("Online Reservation System - SignUp - By Tejas Babar");
    ...
    public void insertintodatabase() {
        try {
            ...
            q1 = "create table if not exists users (username varchar(100) unique not null, password int not null)";
